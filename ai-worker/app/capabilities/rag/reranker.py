...
Two implementations ship here:
  ...
  1. CrossEncoderReranker — production path, lazy-loads
     ...
     default). Any exception inside predict() is swallowed and the
     original top-k is returned unchanged, so a flaky GPU driver or a
     transient CUDA OOM cannot take down the RAG capability.
